    ...
    <div class="row">
        <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <form action="company/account/password-change-process" method="post" class="ajax-form">
                        {{ csrf_field() }}
                        <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button
                        data-action="{{ route('company/account/tfa-status-change') }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap" >
                            ...
                            <div class="" style="margin-bottom: 15px;margin-top: 8px;">
                                ...
                                <button
                                    onclick="app.confirmAction(this);"
                                    data-action="{{ route('company/account/revoke-all') }}"
