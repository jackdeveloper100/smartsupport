...
<div class="modal-footer justify-content-between">
    ...
    <button type="button" class="btn btn-danger" onclick="app.confirmAction(this);" data-action="{{route('company/account/image-delete')}}" data-id="{{$model->image}}">Delete Image</button>
    @endif
    <br>
...
<script>
    ...
    documentReady(function() {
        ...
        app.loadScript('https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.js',function(){
            ...
            imageCrop.init('image-crop','company/account/image-save');
        });
    })
</script>