...
<div class="modal-body">
    <div class="col-md-12 text-center">
        ...
        <div class="image-crop-box" style="max-width:200%;">
            <img src="{{ $general->getFileUrl(@$model->company_logo,'profile'); }}" id="image-crop">
        </div>
...
<div class="modal-footer justify-content-between">
    ...
    <button type="button" class="btn btn-danger" onclick="app.confirmAction(this);" data-action="{{route('company/account/logo-delete')}}" data-id="{{$model->company_logo}}">Delete Logo</button>
    @endif
    <br>
...
<script>
    ...
    documentReady(function() {
        ...
        app.loadScript('https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.js',function(){
            ...
            imageCrop.init('image-crop','company/account/company-logo-save');
        });
    })
</script>