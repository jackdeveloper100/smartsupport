...
documentReady(function() {
    var datatableObj = $('#data-table').DataTable({
         ...
         stateSave :true,
        ajax: {
            url: '{{ route("company/contractor/report-list") }}',
            method: 'POST',
            dataSrc: 'data',
            data: function(d) {
                d.status = $('#status').val();  
    ...
    $('#export-csv').click(function(){
        ...
        window.location.href = '{{ route("company/contractor/report-export") }}' + '?status=' + status +'&docStatus=' + docStatus + '&type=' + 'csv';
    });

    $('#export-pdf').click(function(){
        var status = $('#status').val();
        var docStatus = $('#docStatus').val();
        window.location.href = '{{ route("company/contractor/report-export") }}' + '?status=' + status + '&docStatus=' + docStatus + '&type=' + 'pdf';
    });
      ...
      $('#exportDocuments').click(function () {
        ...
        $.ajax({
            url: '{{ route("company/contractors/export-documents") }}',
            type: 'POST',
            data: data,
