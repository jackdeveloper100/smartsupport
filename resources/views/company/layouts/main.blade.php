        ...
        <body>
            <div id="app">
                        ...
                        <div class="sidebar-wrapper active">
                            <div class="sidebar-header position-relative">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="logo">
                                        <a href="{{ route('company/account/update') }}">
                                ...
                                <div class="sidebar-menu">
                                    <ul class="menu">
                                        ...
                                        <li class="sidebar-item pjax {{ $general->routeMatchClass(['company/dashboard']) }}">
                                            <a href="{{ route('company/dashboard') }}" class="sidebar-link pjax sidebar_hide">
                                        ...
                                        <li class="sidebar-item pjax {{ $general->routeMatchClass(['company/plan']) }}">
                                            ...
                                            <div data-i18n="Report"><span>Plans</span></div>
                                            </a>
                                        </li>
                                        @endif
                                        
                                        <li class="sidebar-item pjax {{ $general->routeMatchClass(['company/support']) }}">
                                            <a href="{{ route('company/support') }}" class="sidebar-link pjax sidebar_hide">
                       ...
                       <header>
                            <nav class="navbar navbar-expand navbar-light navbar-top">
                                <div class="container-fluid" id="layout-menu">
                                    <div class="d-flex align-items-center gap-2 mobile_nav_gap">
                                        <!-- Burger Button -->
                                        ...
                                        <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                                         ...
                                         @if (session('came_from_admin'))
                                            <a href="{{ route('admin/login-back') }}" class="d-flex align-items-center gap-1 mt-2 ms-md-4 ms-1 mobile-back-btn" ><dt class="the-icon"><span class="fa-fw select-all fas"></span></dt>
                                        Back to Admin</a>
                                        @endif
                                    </div>
                                    ...
                                    <div class="layout-menu-toggle navbar-nav align-items-xl-center me-md-3 me-1 me-xl-0 d-xl-none">
                ...
                <!-- Navbar Right Section -->
                                    <div class="navbar-nav-right d-flex align-items-center gap-2 mobile_nav_colla" id="navbar-collapse">
                                        @if($sessionUser)
                                            <div id="google_translate_element" class="google-translate"></div>
                                            <a id="change_language_btn" type="button"><i class="bi bi-translate"><span class="d-sm-inline d-none ms-2">Language</span><span class="d-sm-none d-inline ms-1 mobile_span">Lang</span></i>  </a>
                                        @endif    

                                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                                            <li class="nav-item dropdown me-1 me-md-3">
                                                <a class="nav-link active dropdown-toggle text-gray-600 mobile_drop_noti" href="#" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                                                    <i class='bi bi-bell bi-sub fs-4'></i>
                                                    <span class="badge badge-notification bg-danger">
                                                        <?php echo (new \App\Models\Notification())->getCompanyNotificationCount() ?>
                                                    </span>
                                                </a>
                                                <ul class="dropdown-menu dropdown-center dropdown-menu-sm-end notification-dropdown" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <?php 
                                                        $notificationData = (new \App\Models\Notification())->getLatestNotificationCompany();
                                                    ...
                                                    ?>
                                                        ...
                                                        @foreach ($notificationData as $notification)
                                                            ...
                                                            <li class="dropdown-item notification-item">
                                                                ...
                                                                @if($status == 4)
                                                                <a class="d-flex align-items-center " href="javascript:void(0)" onclick="app.showModalView(' {{ route('company/contractor/new-register-request',['id' => $notification['user_id'], 'type'=>'new register']) }}')" >
                                                                @else
                                                                <a class="d-flex align-items-center " href="company/contractor/view?id=<?php echo $notification['user_id']; ?>&type=notification">
                                                                @endif
                                                        ...
                                                        @endforeach
                                                        <li>
                                                            <p class="text-center py-2 mb-0"><a href="company/contractor/notifications" class="">See All Notifications</a></p>
                                                        </li>
                                                    <?php else : ?>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('company/account/update') }}">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item " href="{{ route('company/auth/logout') }}" id="logout-btn1">
                                                        ...
                                                        <a class="dropdown-item pjax" href="{{ route('admin/account/update') }}">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <span class="fw-semibold d-block">{{ $sessionUser->company_name }}</span>
                        ...
                        <footer class="content-footer footer bg-footer-theme">
                            <div>
                                <div class="footer-container d-flex align-items-center justify-content-between py-2 flex-md-row flex-column">
                                    <div>
                                        ©{{date('Y')}}, made by <a href="company/dashboard" target="_self" class="fw-semibold">{{ config('setting.app_name') }}</a>
                                    </div>
                                </div>
                            </div>
                        </footer>
