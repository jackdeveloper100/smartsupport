...
?>
  ...
  if (!auth()->guest()) {
    ...
    //   $editContent= !auth()->guest() && auth()->user()->type == 0;
  ...
  <head>
    ...
    <!-- Fonts -->
    <link rel="preload" href="/theme/compiled/fonts/nunito-latin-400-normal.woff2" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="/theme/compiled/fonts/nunito-latin-500-normal.woff2" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="/theme/compiled/fonts/nunito-latin-700-normal.woff2" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="/theme/compiled/fonts/nunito-latin-600-normal.woff2" as="font" type="font/woff2" crossorigin>
  ...
  <body>
   ...
   @if(@$editContent && $sessionUser->hasPermission('admin_home_page'))
        <script>
            contentEditor.init();
        </script>
    @endif
