        ...
        <div class="row  main-log-pages">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form class="ajax-form mb-0" action="{{ route('company/auth/password-forgot-process') }}" method="POST" id="ajax-form" >
                        {{ csrf_field() }}
                    ...
                    <div class="text-center mt-2 mt-sm-2 text-lg fs-5">
                        <p class='text-gray-600'>
                            ...
                            <a href="{{ route('company/login') }}" class="font-bold">Log in</a>.
                        </p>
                    </div>
                </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function resendOtp(email) {
            app.ajaxPost('{{ route('company/auth/resend-otp') }}', {type: 'forgot_password', code: btoa(email), token: btoa(email)});
        }
    </script>
    @endpush
