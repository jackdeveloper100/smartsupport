                    ...
                    <h5 class="card-title d-none">Document View</h5>
                        ...
                        <!-- <button class="btn btn-primary" id="previewButton">Preview</button> -->
                         ...
                         <a href="javascript:void(0)" 
                            ...
                            onclick="app.showModalView('{{ route('company/contractor/document-file/preview', ['id' => @$model->id, 'type' => 'documentId']) }}')">Preview</a>
                            <a href="{{ route('company/document/show', ['fileName' => $fileName]) }}" class="btn btn-success" download>Download</a>
                        </div>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body dataTable-container">
                <table class="datatable-list-table table border-top" id="data-table-histry">
                    <thead>
                        <tr>
                        <th>Id</th>
     ...
     <script type="text/javascript">
         documentReady(function(){
            datatableObj = $('#data-table-histry').DataTable({
         pageLength: 25, 
         lengthMenu: [25, 50, 100],
         stateSave :true,
                ajax: {
                    url: '{{route("company/contractor/documents-version",['id'=>@$model->id])}}',
                    method: 'post',
                    dataSrc: 'data',
                    data: {
                    '_token': CSRF_TOKEN
