        ...
        <div class="col-12 col-md-8 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-sm-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Documents Type Update</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="card card-default color-palette-box">
    <div class="card-header justify-content-between">
        <h4 class="align-middle d-sm-inline-block">Documents Type Update</h4>
    </div>
    <div class="card-body">
        <?= view('admin/setting/document_type/_form',compact('model')) ?>
    </div>
</div>
