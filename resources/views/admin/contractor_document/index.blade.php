...
$statusName = isset($_GET['status']) ?$_GET['status'] :  ''; 
...
<div class="row dashboard-head">
        ...
        <div class="col-6 col-lg-4 col-md-6 mb-3">
            <div class="card h-100 mb-0">
                <a href="admin/contractor/documents?status=Active" class="pjax {{$statusName == 'Active' ? 'divActive' : ''}}">
        ...
        <div class="col-6 col-lg-4 col-md-6 mb-3">
            <div class="card h-100 mb-0">
                <a href="admin/contractor/documents?status=Expiring Soon" class="pjax {{$statusName == 'Expiring Soon' ? 'divActive' : ''}}">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            <div class="col-sm-6 col-md-4 col-lg-6 col-xl-6 col-xxl-4 d-flex justify-content-start ">
        ...
        <div class="col-6 col-lg-4 col-md-6 mb-3">
            <div class="card h-100 mb-0">
                <a href="admin/contractor/documents?status=Expired" class="pjax {{$statusName == 'Expired' ? 'divActive' : ''}}">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            <div class="col-sm-6 col-md-4 col-lg-6 col-xl-6 col-xxl-4 d-flex justify-content-start ">
...
documentReady(function () {
    ...
    datatableObj1 = $('#data-table1').DataTable({
        ...
        stateSave :true,
        ajax: {
            url: '{{ route("admin/contractor/documentlist-bystatus") }}',
            method: 'post',
            dataSrc: 'data',
            data: function (d) {
