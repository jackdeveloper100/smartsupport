...
<div class="modal-body" id="zoom-container">
    <div class="img-box" id="object-view">
        @if($extension == 'pdf')
            <iframe src="{{ route('admin/document/show', ['fileName' => $model->filename]) }}" frameborder="0" height="550px" width="100%"></iframe>
        @else
            <img id="zoomImage" class="w-100 active " src="{{ route('admin/document/show', ['fileName' => $model->filename]) }}"  alt="Image Preview">
        @endif
    </div>
</div>
