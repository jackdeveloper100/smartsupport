...
class GeneralService
{
    ...
    public function contactProcess($postData)
    {
        ...
        $general->sendMail(config("setting.admin_email"),'Contact | ' . config('setting.app_name'),view('email.contact',compact('postData'))->render());

        return ['status' => 1,'message' => 'Submit Request Successfully','next' => 'reload'];
    }
