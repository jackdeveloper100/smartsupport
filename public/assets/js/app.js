...
const app = {
     ...
     * @param {Function} cb - Callback function
     */
    confirmAction: function(obj, cb,custom = true) {
        const $obj = $(obj);
        const postData = $obj.data("id") ? { id: $obj.data("id") } : {};
        if(custom == true){
            this.ajaxConfirm($obj.data("action"), postData, cb);
        }else{
            this.ajaxConfirmCustom($obj.data("action"), postData, cb);
        }
     ...
     * @param {Function} cb - Callback function
     */
    ajaxConfirmCustom: function(url, postData, cb) {
        Swal.fire({
          title: 'Delete Request',
          html: `
            Are you sure you want to delete this Request?<br><br>
            <small>
              Note: If the request is already sent, the user if clicked on the link will see "Request not found" page and won't be able to submit the request.
            </small>
          `,
          icon: 'warning',
          showCancelButton: true,
          ...
          customClass: {
            confirmButton: 'btn btn-danger px-4 mx-3',
        ...
        if (result.isConfirmed) { 
            this.ajaxPost(url, postData, (res) => {
     ...
     * @param {Function} cb - Callback function
     */
    confirmW9Action: function(obj, cb) {
        const $obj = $(obj);
        const postData = $obj.data("id") ? { id: $obj.data("id") } : {};
        this.ajaxW9Confirm($obj.data("action"), postData, cb);
    },
     ...
     * @param {Function} cb - Callback function
     */
    ajaxW9Confirm: function(url, postData, cb) {
        Swal.fire({
            title: "Are you sure?",
            html: "Are you sure you want to delete this Request? <br> If the request is already sent, the user if clicked on the link will see Request not found page and won't be able to submit the request",
            icon: "warning",
            showCancelButton: true,
            confirmButtonText: "Yes",
            cancelButtonText: "No",
     ...
     * @param {Function} cb - Callback function
     */
    confirmW9ResendAction: function(obj, cb) {
        const $obj = $(obj);
        const postData = $obj.data("id") ? { id: $obj.data("id") } : {};
        this.ajaxW9ResendConfirm($obj.data("action"), postData, cb);
    },
    ...
    ajaxW9ResendConfirm: function(url, postData, cb) {
    Swal.fire({
        title: "Are you sure?",
        text: "Are you sure you want to request an updated W-9?",
        icon: "info",
        showCancelButton: true,
        confirmButtonText: "Yes",
        cancelButtonText: "No",
        ...
        preConfirm: () => {
            return new Promise((resolve, reject) => {
                ...
                Swal.fire({
                    title: "Processing...",
                    text: "Resending the W9 request. Please wait…",
                    icon: "info",
     ...
     * @param {Function} cb - Callback function
     */
    confirmW9ActionRecived: function(obj, cb) {
        const $obj = $(obj);
        const postData = $obj.data("id") ? { id: $obj.data("id") } : {};
        this.ajaxW9ConfirmRecived($obj.data("action"), postData, cb);
    },
     ...
     * @param {Function} cb - Callback function
     */
    ajaxW9ConfirmRecived: function(url, postData, cb) {
        Swal.fire({
            title: "Are you sure?",
            text: "Are you sure you want to delete this W-9?",
            icon: "warning",
            showCancelButton: true,
            confirmButtonText: "Yes",
            cancelButtonText: "No",
 ...
 /**
    ...
    showProgressLoader: function(message = "Processing...") {
        Swal.fire({
            title: "Processing...",
            text: message,
            icon: "info",
